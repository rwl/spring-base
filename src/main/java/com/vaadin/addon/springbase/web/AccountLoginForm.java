...
public class AccountLoginForm extends LoginForm {
	...
	protected byte[] getLoginHTML() {
	    ...
	    b = "<body onload='setTarget();'"
		      ...
		      + "      method='post'>"
		      + "<table class=\"v-loginform-table\">"
		      + "<tr><td>" + getUsernameCaption() + "</td></tr><tr>"
		      + "<td><input class='v-textfield v-textfield-login login' style='display:block;'"
		      + "           type='text' name='username'></td></tr>"
		      + "<tr><td>" + getPasswordCaption() + "</td></tr><tr>"
		      + "    <td><input class='v-textfield v-textfield-login login'"
		      + "          style='display:block;' type='password'"
		      + "          name='password'></td></tr>"
		      + "<tr><td><div>"
		      + "<div onclick='document.forms[0].submit();'"
		      + "     tabindex='0' class='v-button v-button-login login v-button-wide wide' role='button'>"
